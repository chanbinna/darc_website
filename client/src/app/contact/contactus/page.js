        ...
        <div className={styles.content}>
          ...
          <div className={styles.textbox}>
            ...
            <ul>
              ...
              <li>
                기록해주신 문의와 상담내용은 원활한 상담을 위한 목적으로만
                사용되며, 모든 내용은 비밀이 보장됩니다.
              </li>
              <li>
                상담 비용은 60분에 10만원입니다. 상담 비용은 마약중독연구소
                연구비용으로 사용됩니다.
              </li>
              <li>입금 계좌: 국민은행 20840104388688</li>
              <li>공휴일은 휴무입니다.</li>
            </ul>
          </div>
          ...
          <div className={styles.widgetwrapper}>
            ...
            ></div>
            <link
              href='https://assets.whattime.co.kr/widget/widget.css'
              rel='stylesheet'
            />
          </div>
          ...
          <div className={styles.effect}>
            ...
            >
              <p>
                다르크협회 기업/단체 및 개인의 정보 수집 및 이용 등 처리에 있어
                아래의 사항을 관계 법령에 따라 안내 드립니다. <br />
              </p>
              <ol>
                <li>정보수집의 이용 목적: 온라인 문의/신청</li>
                <li>수집/이용 항목: 성함, 연락처, 이메일</li>
                <li>
                  보유 및 이용기간: 프로그램 종료 후 6개월, 정보제공자의 삭제
                  요청시 즉시
                </li>
