    ...
    <footer className={styles.footer}>
      <div className={styles.footerContainer}>
        ...
        <div className={styles.footerSocials}>
          <a
            href='https://www.youtube.com/channel/UCgBJ6HVUV81VvwsWh4kVhSw'
            target='_blank'
          ...
          <a
            href='https://www.instagram.com/mass9bro/'
            target='_blank'
            rel='noopener noreferrer'
          >
        ...
        <div className={styles.footerInfo2}>
          ...
          <p>사단법인 인천 다르크 협회 이사장: 최진묵</p>
          <p>TEL: +82 70-4046-1445</p>
        </div>

        <div className={styles.footerInfo3}>
          <p>사무실 주소: 미추홀구 독정이로 96, 2층 202호</p>
        </div>
